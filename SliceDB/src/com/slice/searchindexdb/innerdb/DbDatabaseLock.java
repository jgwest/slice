...
public class DbDatabaseLock {
	...
	public DbDatabaseLock(IConfigConstants configConstants) {
	...
	public void loadDBIfNeeded() throws IOException {
		...
		if(_configConstants.getSearchIndex().getType() == Type.JAVA_SRC) {
			if(_dbInst == null) {
				...
				IReadableDatabase2 db = (IReadableDatabase2)ReadableFSDatabaseNew.generateFSDatabaseForRead(new File(javaSrcIndex.getJavaSrcFsDatabasePath()));
