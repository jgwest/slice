...
<div class="indexbox">
	...
	<p>
		Your login/password were correct, and the cookie has been set. You should now be able to use the tools.<br />
	</p>
	<p>
		If you encounter any problems, email your administrator @ <a
			href="mailto:<%=product.getConstants().getSearchAdminEmail()%>"><%=product.getConstants().getSearchAdminEmail()%></a>. <br /> <br />
		<br> 
	</p>
	</div>
</body>
